...
STEP 2:
  ...
  a React element (in this case the spinner) conditionally: o
  nly if the variable on the left is truthy.

  Replace the hard-coded 'true' with the variable that keeps track 
  of whether spinner is on or not.
...
STEP 4:
  This click handler needs to toggle the spinner 
  by setting "whether on" to be the opposite of what it currently is.
